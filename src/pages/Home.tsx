...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home - Web & Flow Worker Cooperative</title>
        <meta
          name="description"
          content="Web & Flow is a worker cooperative in London, Ontario, offering affordable web development services to non-profits, co-ops, and local businesses."
        />
        <link rel="canonical" href="https://webandflow.coop/" />
      </Helmet>
