...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Web & Flow Worker Cooperative</title>
        <meta
          name="description"
          content="Learn more about Web & Flow Worker Cooperative and the team behind it."
        />
        <link rel="canonical" href="https://webandflow.coop/about" />
      </Helmet>
